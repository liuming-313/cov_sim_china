...
def make_sim(n_beds_hosp=2000, n_beds_icu=255, ful_vac_rate=0.692, third_vac_rate='', soc_dis_rate=0.7, factor=100,
    ...
    def vaccinate_by_age_BioNTech_boost(sim):
        ...
        age_3_12 = age_3_12[int(len(age_3_12) * (dose_s * vac_data[key_s][0] - dose_s_boost * vac_data[key][0])/(dose_s*vac_data[key_s][0]-dose_s_boost*vac_data[key][0]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][0])):]
        age_12_19 = age_12_19[int(len(age_12_19) * (dose_s * vac_data[key_s][1] - dose_s_boost * vac_data[key][1])/(dose_s*vac_data[key_s][1]-dose_s_boost*vac_data[key][1]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][1])):]
        age_20_29 = age_20_29[int(len(age_20_29) * (dose_s * vac_data[key_s][2] - dose_s_boost * vac_data[key][2])/(dose_s*vac_data[key_s][2]-dose_s_boost*vac_data[key][2]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][2])):]
        age_30_39 = age_30_39[int(len(age_30_39) * (dose_s * vac_data[key_s][3] - dose_s_boost * vac_data[key][3])/(dose_s*vac_data[key_s][3]-dose_s_boost*vac_data[key][3]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][3])):]
        age_40_49 = age_40_49[int(len(age_40_49) * (dose_s * vac_data[key_s][4] - dose_s_boost * vac_data[key][4])/(dose_s*vac_data[key_s][4]-dose_s_boost*vac_data[key][4]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][4])):]
        age_50_59 = age_50_59[int(len(age_50_59) * (dose_s * vac_data[key_s][5] - dose_s_boost * vac_data[key][5])/(dose_s*vac_data[key_s][5]-dose_s_boost*vac_data[key][5]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][5])):]
        age_60_69 = age_60_69[int(len(age_60_69) * (dose_s * vac_data[key_s][6] - dose_s_boost * vac_data[key][6])/(dose_s*vac_data[key_s][6]-dose_s_boost*vac_data[key][6]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][6])):]
        age_70_79 = age_70_79[int(len(age_70_79) * (dose_s * vac_data[key_s][7] - dose_s_boost * vac_data[key][7])/(dose_s*vac_data[key_s][7]-dose_s_boost*vac_data[key][7]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][7])):]
        age_80 = age_80[int(len(age_80) * (dose_s * vac_data[key_s][8] - dose_s_boost * vac_data[key][8])/(dose_s*vac_data[key_s][8]-dose_s_boost*vac_data[key][8]+vac_data[nu+'_'+method+'_b'][9]*vac_data[nu+'_'+method+'_b'][8])):]
